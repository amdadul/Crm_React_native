...
import {serialNoVerifyApi} from '../api/CrmApi';

const SerialNoVerify = ({setIsPreview, setIsLoading, setData}) => {
  ...
  const onSubmit = async data => {
    setIsLoading(true);
    const response = await serialNoVerifyApi(data);
    setIsLoading(false);
